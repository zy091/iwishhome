    ...
    <div class="word-viewer-container">
        ...
        <div class="viewer-header">
            <div class="header-left">
                <span class="file-title">了解艾维公司</span>
            </div>
...
// Word文档URL
const wordUrl = 'https://oziqjzzrouoclocfgoub.supabase.co/storage/v1/object/public/documents/word-files/learn-iwish.docx'

// 加载Word文档
const loadWordDocument = async () => {
    loading.value = true
    try {
        console.log('开始加载Word文档:', wordUrl)
